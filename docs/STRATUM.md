...
```javascript
{
  "id": 1,
  "jsonrpc": "2.0",
  "method": "wsh_submitLogin",
  "params": ["0xc285f9dc21232fe887830234631adb9544e40d31"]
}
```
...
```javascript
{
  ...
  "jsonrpc": "2.0",
  "method": "wsh_submitLogin",
  "params": ["0xc285f9dc21232fe887830234631adb9544e40d31", "admin@example.net"]
}
```
...
```javascript
{ "id": 1, "jsonrpc": "2.0", "method": "wsh_getWork" }
```
...
`wsh_submitHashrate` is a nonsense method. Pool ignores it and the reply is always:
