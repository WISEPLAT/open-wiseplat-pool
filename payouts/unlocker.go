...
const minDepth = 16
const byzantiumHardForkHeight = 5
...
const donationAccount = "0xc285f9dc21232fe887830234631adb9544e40d31"
...
/* Gwsh does not provide consistent state when you need both new height and new job,
 ...
 * ISSUE: https://github.com/wiseplat/go-wiseplat/issues/2333
 */
...
func matchCandidate(block *rpc.GetBlockReply, candidate *storage.BlockData) bool {
	...
	// Gwsh-style candidate matching
	if len(block.Nonce) > 0 {
		return strings.EqualFold(block.Nonce, candidate.Nonce)
	}
	// Parity's EIP: https://github.com/wiseplat/EIPs/issues/95
